...
import { createApplicationAirTemperature } from './layers/airTemperature.js';
  ...
  try {
    ...
    const catalog = createLayerCatalog(
      [
        ...
        vessels,
        installations,
        createApplicationAirTemperature({ source: sources.airTemperature }),
